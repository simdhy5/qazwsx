 ...
 <div class="main">
  ...
  <div class="join-step">
   ...
   <p>주소검색</p>
    ...
    도로명주소 : <input type="text" id="roadAddress" placeholder="도로명주소"> <br>
    지번    주소 : <input type="text" id="jibunAddress" placeholder="지번주소"> <br>
  ...
  <form action="join-form2.do" method="post">
   최종 배달주소 : <input type="text" name="inputAddr" id="inputAddr"> <br>
   배달 특이사항 : <input type="text" name="memo" placeholder="예)아이가 있으니 노크해주세요.">
