...
<div class="root">
 ...
 <div class="row main">
   ...
   *성함:<input type="text" name="inputName"> <br>
        성별:<input type="text" name="inputGend"> <br>
   *휴대폰 번호:<input type="text" name="inputPhon" placeholder="숫자만 입력"> <br>
   
   <h2 class="subtitle">계정 정보</h2>   
   
   *이메일:<input type="text" name="inputEmai" placeholder="name@mail.com"> <br>
    <p class="helper">이메일 주소는 고객님의 안전한 거래와 회원정보 보호를 위해 정확하게 입력해 주세요.</p>
   *이메일 확인:<input type="text" name="inputEmai2" placeholder="name@mail.com"> <br>
   ...
   *비밀번호 확인:<input type="password" name="inputPw2"> <br>   
   ...
   <h2 class="subtitle">인증방법</h2> 
   <p class="helper">인증코드가 선택하신 인증방법(휴대폰문자 혹은 이메일)으로 발송됩니다.</p>             
   <input type="radio">
